...
<script type="text/javascript">
	...
	$(function() {
		...
		window.setTimeout(function(){
			$.messager.show({
				title:"消息提示",
				msg:'欢迎<shiro:principal property="email"></shiro:principal>登录，超级管理员！ <a href="javascript:void" onclick="top.showAbout();">联系管理员</a>',
				timeout:5000
			});
		},3000);
		/*************/
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		...
		<div id="sessionInfoDiv"
			...
			[<strong>超级管理员</strong>]，欢迎你！您使用[<shiro:principal property="email"></shiro:principal>]IP登录！
		</div>
