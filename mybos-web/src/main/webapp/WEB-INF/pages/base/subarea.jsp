...
<script type="text/javascript">
	...
	function doEdit(){
		 var subarea=$('#grid').datagrid('getSelected');
		 if(subarea==null) {
			 $.messager.alert("警告","请选中一行","warning");
		 }else {
			 $('#addSubareaWindow').window("open");
			 $("#addSubareaForm").form("load",subarea);
			$('#regionId').combobox('setValue',subarea.region.id);
			$('#regionId').combobox('setText',subarea.region.name);		
		 }
	}
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/subareaAction_pagination",
			idField : 'id',
			columns : columns,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" method="post" action="${pageContext.request.contextPath}/subareaAction_save">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						...
						<td>
							...
							<input class="easyui-combobox" name="region.id"  id="regionId" 
    							data-options="mode:'remote',valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/regionAction_ajaxList'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
					...
					<tr>
						<td>单双号</td>
						<td>
							<select class="easyui-combobox" name="oodnum" style="width:150px;">  
